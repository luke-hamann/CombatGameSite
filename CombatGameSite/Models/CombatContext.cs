    ...
    public class CombatContext(DbContextOptions<CombatContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Character>().HasData(
                new Character { Id = 1, UserId = 1, Name = "Aqua Warrior", TypeId = 2, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A1", SkillSecondaryId = "A2", SkillTertiaryId = "H1" },
                new Character { Id = 2, UserId = 2, Name = "Flame Destroyer", TypeId = 4, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "A3", SkillSecondaryId = "A4", SkillTertiaryId = "H1" },
                new Character { Id = 3, UserId = 3, Name = "Wind Ninja", TypeId = 4, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "A5", SkillSecondaryId = "A6", SkillTertiaryId = "H1" },
                new Character { Id = 4, UserId = 4, Name = "Earth Titan", TypeId = 2, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A7", SkillSecondaryId = "A8", SkillTertiaryId = "H1" },
                new Character { Id = 5, UserId = 1, Name = "Water Sage", TypeId = 1, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "A9", SkillSecondaryId = "A10", SkillTertiaryId = "H1" },
                new Character { Id = 6, UserId = 2, Name = "Fire Knight", TypeId = 3, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "A11", SkillSecondaryId = "A12", SkillTertiaryId = "H1" },
                new Character { Id = 7, UserId = 3, Name = "Wind Shaman", TypeId = 2, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A13", SkillSecondaryId = "A13", SkillTertiaryId = "H1" },
                new Character { Id = 8, UserId = 4, Name = "Earth Wizard", TypeId = 1, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "H1", SkillSecondaryId = "H1", SkillTertiaryId = "H1" },
                new Character { Id = 9, UserId = 1, Name = "Water Spirit", TypeId = 4, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "H1", SkillSecondaryId = "H1", SkillTertiaryId = "H1" },
                new Character { Id = 10, UserId = 2, Name = "Flame Phoenix", TypeId = 2, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "H1", SkillSecondaryId = "H1", SkillTertiaryId = "H1" },
                new Character { Id = 11, UserId = 3, Name = "Wind Warrior", TypeId = 3, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "A1", SkillSecondaryId = "A2", SkillTertiaryId = "H2" },
                new Character { Id = 12, UserId = 4, Name = "Fire Sorcerer", TypeId = 4, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "A3", SkillSecondaryId = "A4", SkillTertiaryId = "H2" },
                new Character { Id = 13, UserId = 1, Name = "Wind Elf", TypeId = 2, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A5", SkillSecondaryId = "A6", SkillTertiaryId = "H2" },
                new Character { Id = 14, UserId = 2, Name = "Earth Golem", TypeId = 4, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "A7", SkillSecondaryId = "A8", SkillTertiaryId = "H2" },
                new Character { Id = 15, UserId = 3, Name = "Water Knight", TypeId = 2, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "A9", SkillSecondaryId = "A10", SkillTertiaryId = "H2" },
                new Character { Id = 16, UserId = 4, Name = "Fire Wizard", TypeId = 2, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A11", SkillSecondaryId = "A12", SkillTertiaryId = "H2" },
                new Character { Id = 17, UserId = 1, Name = "Wind Shaman", TypeId = 3, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "A13", SkillSecondaryId = "A13", SkillTertiaryId = "H2" },
                new Character { Id = 18, UserId = 2, Name = "Water Guardian", TypeId = 2, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "H1", SkillSecondaryId = "H1", SkillTertiaryId = "H2" },
                new Character { Id = 19, UserId = 3, Name = "Flame Demon", TypeId = 1, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "H1", SkillSecondaryId = "H1", SkillTertiaryId = "H2" },
                new Character { Id = 20, UserId = 4, Name = "Wind Demon", TypeId = 2, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "H1", SkillSecondaryId = "H1", SkillTertiaryId = "H2" },
                new Character { Id = 21, UserId = 1, Name = "Water Monk", TypeId = 2, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "A1", SkillSecondaryId = "A2", SkillTertiaryId = "H3" },
                new Character { Id = 22, UserId = 2, Name = "Fire Samurai", TypeId = 1, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A3", SkillSecondaryId = "A4", SkillTertiaryId = "H3" },
                new Character { Id = 23, UserId = 3, Name = "Wind Warrior", TypeId = 3, Health = 50, Defense = 50, Species = "Elf", SkillPrimaryId = "A5", SkillSecondaryId = "A6", SkillTertiaryId = "H3" },
                new Character { Id = 24, UserId = 4, Name = "Earth Beast", TypeId = 1, Health = 50, Defense = 50, Species = "Dwarf", SkillPrimaryId = "A7", SkillSecondaryId = "A8", SkillTertiaryId = "H3" },
                new Character { Id = 25, UserId = 1, Name = "Water Sorceress", TypeId = 3, Health = 50, Defense = 50, Species = "Human", SkillPrimaryId = "A9", SkillSecondaryId = "A10", SkillTertiaryId = "H3" }
            );
